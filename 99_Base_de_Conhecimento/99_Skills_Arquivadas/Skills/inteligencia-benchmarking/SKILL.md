...
description: Especialista em Auditoria de Qualidade e Benchmarking Militar. Use para comparar documentos CBMAL com referências (CBMDF, NFPA, ONU), aplicar frameworks ISO/TCU e emitir scores de maturidade.
---
