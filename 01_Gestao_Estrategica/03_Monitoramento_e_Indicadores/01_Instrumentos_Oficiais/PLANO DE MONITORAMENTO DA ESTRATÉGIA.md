...
## **COMANDANTE-GERAL DO CBMAL:** Cel QOEM BM Sérgio André Silva Verçosa

## **CHEFE DO ESTADO-MAIOR GERAL DO CBMAL:** Cel QOEM BM Eduardo Hercules da Silva Justo

## **ASSESSOR DE PLANEJAMENTO E ORÇAMENTO:** TC QOEM BM Marcos Paulo Seara Barbosa

## **CHEFE DA SEÇÃO DE GESTÃO ESTRATÉGICA:** 1º Ten QOEM Gabriel Dantas da Cruz
...
2. **GOVERNANÇA E CADEIA DE VALOR**  
3. **SISTEMÁTICA DE INDICADORES (KPIs)**  
4. **CICLOS DE ACOMPANHAMENTO (RITO)**  
5. **AÇÕES CORRETIVAS E GESTÃO DE PRAZOS**  
   * **ANEXO I** **\-** Ficha Técnica do Indicador  
   * **ANEXO II** **\-** Calendário das RMEs  
   * **ANEXO III \-** Modelo de Plano de Contramedida (PCM)  
   * **ANEXO IV \-** Estrutura do Relatório de Farol (BGO)  
   * **ANEXO V \-** Modelo de Ata de RME
...
O **Plano de Monitoramento da Estratégia** tem por finalidade estabelecer a sistemática de acompanhamento, controle e avaliação do desempenho institucional do CBMAL. Este instrumento regulamenta a **Seção 6 \- Monitoramento e Avaliação** do *Plano de Implementação da Estratégia 2025-2029*, operacionalizando a cultura de gestão por resultados.

### **1.1. Conceito de Monitoramento**

No âmbito do CBMAL, monitoramento não é fiscalização punitiva, mas uma **vigilância ativa e contínua** sobre a execução da estratégia. Seu objetivo é fornecer informações tempestivas para a tomada de decisão, permitindo:  
1\. Identificar desvios de rota antecipadamente.  
2\. Celebrar conquistas e vitórias de curto prazo.  
3\. Promover o aprendizado organizacional baseada em evidências.

A metodologia adota o ciclo **PDCA** (Plan-Do-Check-Act), onde o Monitoramento representa a etapa de **CHECK**, fundamental para o ajuste de rumos (**ACT**).  
---

## **2\. GOVERNANÇA E CADEIA DE VALOR**

A estrutura de governança do monitoramento define "quem faz o quê" no processo de coleta e análise de dados.
...
O fluxo de informação deve garantir a oficialidade e a integridade dos dados:
...
Os Indicadores-Chave de Desempenho (KPIs) são os termômetros da estratégia.
...
O monitoramento ocorre em ciclos pré-definidos para criar disciplina institucional. A eficácia do rito depende da preparação prévia e do foco na tomada de decisão durante os encontros presenciais.

### **4.1. Reuniões de Monitoramento Estratégico (RME)**

As RMEs são o fórum principal de governança. Não são reuniões de "leitura de relatório", mas sim de **tomada de decisão**.
...
A reunião deve ser objetiva e focada na solução de problemas.
...
4. **Monitoramento de Riscos (20 min)**:  
   * Revisão dos riscos críticos (Matriz de Riscos Institucionais).  
   * Verificação da efetividade das medidas mitigadoras.  
5. **Deliberações e Encerramento (20 min)**:  
   * Aprovação dos Planos de Contramedida.  
   * Decisões de alocação de recursos ou desbloqueio de travas administrativas.  
...
Em conformidade com o *Plano de Comunicação* (Anexo Único do Plano de Implementação), os resultados monitorados devem ser publicizados para a tropa:  
\* **Boletim Geral Ostensivo (BGO)**: Publicação das Atas das RMEs e do Extrato de Desempenho Trimestral.  
\* **Intranet / Mural**: Afixação do "Painel de Bordo" (Farol) atualizado nas Diretorias.  
...
A data exata será definida em Boletim Geral, mas o ciclo de referência segue o padrão abaixo para previsibilidade das Diretorias:

| Reunião | Fatos Geradores (Trimestre) | Data Limite (Previsão) | Escopo Principal |
| :---: | :---: | :---: | :---: |
| **1ª RME** | Jan, Fev, Mar (1º Trim) | **2ª Quinzena de Maio** | Avaliação inicial do ano. |
| **2ª RME** | Abr, Mai, Jun (2º Trim) | **2ª Quinzena de Agosto** | Correção de meio de ciclo. |
...
Deve ser preenchido por todo ODS que apresentar indicador com desempenho **VERMELHO** ou **AMARELO** persistente.

| Cabeçalho |  |
| :---- | :---- |
| **Setor Responsável** | *Ex: Diretoria de Saúde* |
| **Indicador Afetado** | *Ex: Tempo de Espera por Junta Médica* |
| **Meta / Realizado** | *Meta: 15 dias / Realizado: 45 dias* |
...
| O Que (Ação) | Quem (Responsável) | Quando (Prazo) | Como (Recurso) | Status |
| :---: | :---: | :---: | :---: | :---: |
| *Solicitar credenciamento de clínicas externas* | *Dir. Saúde* | *30/Jun* | *Processo SEI nº...* | *A Iniciar* |
| *Realizar mutirão de fim de semana* | *Ch Juntas* | *15/Mai* | *Escala Extra* | *Em Andamento* |

---

### **Anexo IV \- Estrutura do Relatório de Farol (BGO)**

Modelo de extrato executivo para publicação em Boletim Geral Ostensivo (Transparência).

**EXTRATO DE DESEMPENHO ESTRATÉGICO \- \[TRIMESTRE/ANO\]**

**1\. Resumo do Período**  
O CBMAL atingiu **X%** das metas previstas para o período. Destaque para a redução do tempo resposta e aumento das vistorias.

**2\. Painel de Indicadores (Farol)**

| Objetivo Estratégico | Indicador | Meta | Realizado | Farol |
| :---: | :---: | :---: | :---: | :---: |
| *Salvar Vidas* | *Tempo Resposta* | *\< 12 min* | *11 min* | 🟢 |
| *Reduzir Riscos* | *Vistorias Técnicas* | *2.000* | *1.500* | 🔴 |
| *Valorizar Tropa* | *Satisfação Interna* | *Net Promoter* | *8.5* | 🟡 |

**3\. Deliberações da RME**  
O Alto Comando determinou a abertura de Plano de Contramedida para a *Diretoria de Atividades Técnicas* visando regularizar o passivo de vistorias até o próximo trimestre.  
---

### **Anexo V \- Modelo de Ata de RME**

**ATA DA \[Nº\]ª REUNIÃO DE MONITORAMENTO ESTRATÉGICO**

**Data**: DD/MM/AAAA | **Local**: Sala de Situação QCG | **Horário**: 09h00 \- 11h00
...
A APO apresentou o desempenho global de **85%**.

**Pauta 2: Monitoramento de Riscos**  
Foi alertado sobre o risco orçamentário para aquisição de viaturas.

**Pauta 3: Deliberações (Decisões Tomadas)**  
1\. **APROVADO** o Plano de Contramedida da Diretoria de Ensino.  
2\. **DETERMINADO** que a DAL apresente estudo de viabilidade para nova licitação em 15 dias.  
3\. **REPACTUADA** a meta do indicador de "Inovação" para o 2º semestre, devido a atraso tecnológico.
