# 🧠 DNA DO SISTEMA (Second Brain)

Este arquivo é a memória de longo prazo do Agente Conductor. Ele armazena decisões pétreas, aprendizados técnicos e regras de negócio para evitar redundância e perda de contexto.

---

## 🏛️ Decisões Estratégicas (Log de Decisões)
...
| 26/01/2026 | **Benchmarking Medin** | Implementação de "Compounding Context" (Contexto Composto) local via MDs. | Em Curso 🚀 |
| 25/01/2026 | **Energy First** | Produtividade será baseada em Gestão de Energia (não tempo). Picos = Deep Work. | Implementado ✅ |
| 25/01/2026 | **PKM Simplificado** | Princípio KISS. Obsidian foca em conhecimento, não em gestão total (calendar/mail). | Permanente 🔒 |

---

## 🎨 Identidade e Padrões (Brand System)

**Referência Completa**: [`brands/CBMAL.md`](file:///c:/Users/D_A_N/OneDrive/Desktop/Planejamento%20Estrat%C3%A9gico%20-%20CBMAL/brands/CBMAL.md)

### Quick Reference (Cores Principais)

* **Vermelho CBMAL**: `#FF1A24` (Brasão, alertas)
* **Vermelho Assinatura**: `#C10A0A` (Documentos oficiais)
* **Amarelo CBMAL**: `#FFFF00` (Sinalização, atenção)
* **Azul**: `#4A94FF` (Elementos aquáticos, títulos)

### Tipografia

* **Família Oficial**: Exo 2 (Thin, Regular, Black)
* **Títulos**: Exo 2 Black
* **Corpo**: Exo 2 Regular

### Tom de Voz

* Formal, militar, direto e tecnicamente preciso. Padrão CBMAL.

---

## 🛠️ Regras Técnicas Aprendidas

1. **Contexto Fresh**: O Agente deve ler o `DNA_DO_SISTEMA.md` no início de cada sessão (`/sincronizar`).
2. **Snapshot Testing**: Preferir o uso de árvores de acessibilidade (snapshots) para auditoria de processos, em vez de capturas de tela puras.
