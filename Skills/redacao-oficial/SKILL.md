...
- **Estrutura**:
  ...
  2. Número: `Ofício nº E:XXX/2026/CBMAL`
  3. Local e Data: `Maceió-AL, na data da assinatura.`
  4. Destinatário: `Ao Senhor [Nome] - [Posto] [Quadro]` + Cargo
  5. Assunto: Resumo do conteúdo (máx. 5 palavras)
  6. Vocativo: `Senhor [Cargo],`
  7. Texto: Parágrafos numerados (1., 2., 3...)
  8. Fecho: `Respeitosamente,` (superiores) ou `Atenciosamente,` (demais)
...
- ✅ Pode ser assinado por mais de um bombeiro militar
- ✅ Para publicação em DOE/BGO, usar extrato

| Subtipo | SEI | Quando usar |
|---------|-----|-------------|
| **Decisório** | 22980057 | Dá solução e põe termo à questão. |
| **Ordinatório** | 22981191 | Apenas dá andamento ao documento (sem decisão). |
| **Interlocutório** | 22981252 | Emite parecer técnico e transfere decisão a superior. |
| **Saneador** | 22981436 | Resolve falhas no procedimento. |
...
- **Elementos**:
  - Epígrafe: `PORTARIA/CBMAL Nº XX/2026`
  - Ementa: Resumo do objeto
  - Preâmbulo: Autoridade, fundamento legal, considerandos
  - Artigos (Art. 1º, Art. 2º...)
...
## 📐 Padrão Ofício (Unificação)

> [!IMPORTANT]
> Os documentos **Ofício, Solicitação, Aviso, Informação e Memorando** foram unificados em um único formato chamado **Padrão Ofício**, conforme Art. 1º, §1º.
...
| Espaçamento | Simples (1.0) ou 1.5 |
| Margens | Superior 2cm, Inferior 2cm, Esquerda 3cm, Direita 1,5cm |
...
| Oficiais Superiores (Cel, TC, Maj) | Senhor [Posto] | Respeitosamente |
| Oficiais Intermediários/Subalternos | Senhor [Posto] | Atenciosamente |
...
2. **Clareza**: Frases curtas, ordem direta (Sujeito + Verbo + Predicado).
3. **Concisão**: Elimine adjetivos desnecessários.
4. **Formalidade**: Pronomes de tratamento corretos.
5. **Uniformidade**: Siga os modelos SEI.

---

## 📚 Referências de Modelos SEI

| Documento | Nº SEI |
|-----------|--------|
| Ofício | 22979797 |
| Ofício Circular | 22979839 |
| Despacho Decisório | 22980057 |
| Despacho Ordinatório | 22981191 |
| Despacho Interlocutório | 22981252 |
| Despacho Saneador | 22981436 |
| Despacho Circular | 22982545 |
| Portaria | 22983246 |
| Ordem de Serviço | 22983688 |
| Requerimento | 22984075 |
| Parte | 22984269 |
| Comunicação | 22985769 |
| Nota para Publicação | 23234551 |
| Extrato de Despacho | 23269045 |

---
*Última Atualização: 20/01/2026*
*Versão: 2.0 (Portaria 18/2024)*
